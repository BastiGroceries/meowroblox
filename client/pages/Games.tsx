...
const featuredGames = [
  {
    ...
    players: "1-50",
    isNew: true,
    description: "Complete adventure game with quests, NPCs, and multiple levels"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    players: "1-100",
    isFeatured: true,
    description: "Epic space adventure with planets, ships, and alien encounters"
  },
  {
    id: 4,
        ...
        <section className="bg-gradient-to-br from-brand-blue-50 to-white py-16 px-4">
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              ...
              From epic adventures to competitive racing - find your next favorite game!
            </p>
              ...
              {gameCategories.map((category) => (
                <Card key={category.id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-md rounded-2xl overflow-hidden">
                  ...
                  <CardFooter className="p-6 pt-0">
                    <Link to={`/products/c=${category.name.toLowerCase().replace(/[^a-z0-9]/g, '')}/p=game`} className="w-full">
                      <Button 
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {featuredGames.map((game) => (
                <Card key={game.id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-md rounded-2xl overflow-hidden">
