...
const featuredTemplates = [
  {
    ...
    buildTime: "2-3 hours",
    isNew: true,
    description: "Complete city template with buildings, roads, and detailed environments"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    buildTime: "1 hour",
    isNew: true,
    description: "Complete school building template with classrooms and facilities"
  }
];
        ...
        <section className="bg-gradient-to-br from-brand-blue-50 to-white py-16 px-4">
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Jump-start your Roblox creations with our professionally designed templates. 
              From modern cities to medieval castles - build faster with pre-made designs.
            </p>
              ...
              {templateCategories.map((category) => (
                <Card key={category.id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-md rounded-2xl overflow-hidden">
                  ...
                  <CardFooter className="p-6 pt-0">
                    <Link to={`/products/c=${category.name.toLowerCase().replace(/[^a-z0-9]/g, '')}/p=template`} className="w-full">
                      <Button 
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {featuredTemplates.map((template) => (
                <Card key={template.id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-md rounded-2xl overflow-hidden">
                  <div className="lg:flex">
                    ...
                    <CardContent className="lg:w-1/2 p-6 flex flex-col justify-between">
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="text-gray-800 font-medium">{template.buildTime}</span>
                          </div>
                          <div className="flex items-center justify-between">
                      ...
                      <Button 
                        className="w-full bg-brand-blue hover:bg-brand-blue-dark text-white font-semibold py-3 rounded-xl transition-all duration-200 mt-4"
                      >
                        Download Template
                      </Button>
                    </CardContent>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Skip hours of building with our ready-to-use templates. Focus on customization and gameplay.
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  All templates are crafted by experienced designers with attention to detail and aesthetics.
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Our templates are built with modularity in mind, making customization simple and flexible.
                </p>
              </div>
            </div>
          </div>
