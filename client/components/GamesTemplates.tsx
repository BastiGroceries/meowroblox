...
const sampleContent: GameTemplate[] = [
  ...
  },
  {
    ...
    description: "Fully detailed city template with buildings, roads, and environments",
    type: "template",
    rating: 4.9
  },
  {
  ...
  },
  {
    ...
    description: "Sci-fi space adventure with planets, ships, and alien encounters",
    type: "game",
    rating: 4.9
  },
  {
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Ready-to-use games and building templates to jumpstart your Roblox creations
          </p>
        </div>
